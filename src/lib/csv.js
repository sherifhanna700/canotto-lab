...
import { overallScore, SCORE_KEYS } from '../model/recipes.js?v=bbceb21b';
import { cToF } from '../model/units.js?v=bbceb21b';
import { ovenLabel, mixerLabel } from '../model/equipment.js?v=bbceb21b';
