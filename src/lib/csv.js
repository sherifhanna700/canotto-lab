...
import { overallScore, SCORE_KEYS } from '../model/recipes.js?v=53a849de';
import { cToF } from '../model/units.js?v=53a849de';
import { ovenLabel, mixerLabel } from '../model/equipment.js?v=53a849de';
