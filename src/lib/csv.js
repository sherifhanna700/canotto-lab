...
import { overallScore, SCORE_KEYS } from '../model/recipes.js?v=2313eb03';
import { cToF } from '../model/units.js?v=2313eb03';
import { ovenLabel, mixerLabel } from '../model/equipment.js?v=2313eb03';
