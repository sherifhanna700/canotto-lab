...
import { overallScore, SCORE_KEYS } from '../model/recipes.js?v=97765f5d';
import { cToF } from '../model/units.js?v=97765f5d';
import { ovenLabel, mixerLabel } from '../model/equipment.js?v=97765f5d';
