...
import { DEFAULT_RECIPE } from '../model/dough.js?v=edc1a2f1';
import { DEFAULT_SCHEDULE } from '../model/protocol.js?v=edc1a2f1';
import { DEFAULT_MODEL } from '../model/ferment.js?v=edc1a2f1';
import { starterRecipes, houseRecipe } from '../model/recipes.js?v=edc1a2f1';
import { DEFAULT_EQUIPMENT } from '../model/equipment.js?v=edc1a2f1';
