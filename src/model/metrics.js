...
import { computeRecipe } from './dough.js?v=14919de0';
import { scheduleStages } from './protocol.js?v=14919de0';
import { fermentUnits, ripeness } from './ferment.js?v=14919de0';
import { convertYeast } from './dough.js?v=14919de0';
import { overallScore, SCORE_KEYS } from './recipes.js?v=14919de0';
import { toDisplay } from './units.js?v=14919de0';
import { ovenLabel, mixerLabel } from './equipment.js?v=14919de0';
