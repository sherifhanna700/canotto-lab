...
import { computeRecipe } from './dough.js?v=1c325d9e';
import { scheduleStages } from './protocol.js?v=1c325d9e';
import { fermentUnits, ripeness } from './ferment.js?v=1c325d9e';
import { convertYeast } from './dough.js?v=1c325d9e';
import { overallScore, SCORE_KEYS } from './recipes.js?v=1c325d9e';
import { toDisplay } from './units.js?v=1c325d9e';
import { ovenLabel, mixerLabel } from './equipment.js?v=1c325d9e';
