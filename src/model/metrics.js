...
import { computeRecipe } from './dough.js?v=6b063ab5';
import { scheduleStages } from './protocol.js?v=6b063ab5';
import { projectedStages, PHASE_BOUNDS, hasTimings } from './timeline.js?v=6b063ab5';
import { fermentUnits, maturationUnits } from './ferment.js?v=6b063ab5';
import { convertYeast } from './dough.js?v=6b063ab5';
import { overallScore, SCORE_KEYS } from './recipes.js?v=6b063ab5';
import { maturationCeilingForW } from './flours.js?v=6b063ab5';
import { toDisplay } from './units.js?v=6b063ab5';
import { ovenLabel, mixerLabel } from './equipment.js?v=6b063ab5';
