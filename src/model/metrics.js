...
import { computeRecipe } from './dough.js?v=1903f6bd';
import { scheduleStages } from './protocol.js?v=1903f6bd';
import { projectedStages, PHASE_BOUNDS, hasTimings } from './timeline.js?v=1903f6bd';
import { fermentUnits, maturationUnits } from './ferment.js?v=1903f6bd';
import { convertYeast } from './dough.js?v=1903f6bd';
import { overallScore, SCORE_KEYS } from './recipes.js?v=1903f6bd';
import { maturationCeilingForW } from './flours.js?v=1903f6bd';
import { toDisplay } from './units.js?v=1903f6bd';
import { ovenLabel, mixerLabel } from './equipment.js?v=1903f6bd';
