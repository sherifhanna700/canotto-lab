...
import { fmtGrams, fmtTemp, fmtDuration } from './units.js?v=23f40929';
import { stageFlourLabel } from './dough.js?v=23f40929';
import { mixerPhrasing, mixerLabel } from './equipment.js?v=23f40929';
