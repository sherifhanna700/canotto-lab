...
import { DEFAULT_RECIPE } from './dough.js?v=24df1a08';
import { DEFAULT_SCHEDULE } from './protocol.js?v=24df1a08';
import { blendStats, blendLabel } from './flours.js?v=24df1a08';
import { suggestPlan, defaultLeadHours } from './advisor.js?v=24df1a08';
