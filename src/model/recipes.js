...
import { DEFAULT_RECIPE } from './dough.js?v=2313eb03';
import { DEFAULT_SCHEDULE } from './protocol.js?v=2313eb03';
import { blendStats, blendLabel } from './flours.js?v=2313eb03';
import { suggestPlan, defaultLeadHours } from './advisor.js?v=2313eb03';
