...
import { DEFAULT_RECIPE } from './dough.js?v=23f40929';
import { DEFAULT_SCHEDULE } from './protocol.js?v=23f40929';
import { blendStats, blendLabel } from './flours.js?v=23f40929';
import { suggestPlan, defaultLeadHours } from './advisor.js?v=23f40929';
