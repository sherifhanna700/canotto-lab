...
import { DEFAULT_RECIPE } from './dough.js?v=14919de0';
import { DEFAULT_SCHEDULE } from './protocol.js?v=14919de0';
import { blendStats, blendLabel } from './flours.js?v=14919de0';
import { suggestPlan, defaultLeadHours } from './advisor.js?v=14919de0';
