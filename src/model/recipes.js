...
import { DEFAULT_RECIPE } from './dough.js?v=53a849de';
import { DEFAULT_SCHEDULE } from './protocol.js?v=53a849de';
import { blendStats, blendLabel } from './flours.js?v=53a849de';
import { suggestPlan, defaultLeadHours } from './advisor.js?v=53a849de';
