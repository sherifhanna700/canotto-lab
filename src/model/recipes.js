...
import { DEFAULT_RECIPE } from './dough.js?v=4b76d5b2';
import { DEFAULT_SCHEDULE } from './protocol.js?v=4b76d5b2';
import { blendStats, blendLabel } from './flours.js?v=4b76d5b2';
import { suggestPlan, defaultLeadHours } from './advisor.js?v=4b76d5b2';
