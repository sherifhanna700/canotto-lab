...
import { DEFAULT_RECIPE } from './dough.js?v=37fdeb15';
import { DEFAULT_SCHEDULE } from './protocol.js?v=37fdeb15';
import { blendStats, blendLabel } from './flours.js?v=37fdeb15';
import { suggestPlan, defaultLeadHours } from './advisor.js?v=37fdeb15';
