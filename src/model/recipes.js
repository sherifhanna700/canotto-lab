...
import { DEFAULT_RECIPE } from './dough.js?v=87d1918f';
import { DEFAULT_SCHEDULE } from './protocol.js?v=87d1918f';
import { blendStats, blendLabel } from './flours.js?v=87d1918f';
import { suggestPlan, defaultLeadHours } from './advisor.js?v=87d1918f';
