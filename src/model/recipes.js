...
import { DEFAULT_RECIPE } from './dough.js?v=3463b6fe';
import { DEFAULT_SCHEDULE } from './protocol.js?v=3463b6fe';
import { blendStats, blendLabel } from './flours.js?v=3463b6fe';
import { suggestPlan, defaultLeadHours } from './advisor.js?v=3463b6fe';
