...
import { DEFAULT_RECIPE } from './dough.js?v=15b611c0';
import { DEFAULT_SCHEDULE } from './protocol.js?v=15b611c0';
import { blendStats, blendLabel } from './flours.js?v=15b611c0';
import { suggestPlan, defaultLeadHours } from './advisor.js?v=15b611c0';
