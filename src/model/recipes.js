...
import { DEFAULT_RECIPE } from './dough.js?v=457ebcf0';
import { DEFAULT_SCHEDULE } from './protocol.js?v=457ebcf0';
import { blendStats, blendLabel } from './flours.js?v=457ebcf0';
import { suggestPlan, defaultLeadHours } from './advisor.js?v=457ebcf0';
