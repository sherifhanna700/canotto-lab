...
import { DEFAULT_RECIPE } from './dough.js?v=18086ea6';
import { DEFAULT_SCHEDULE } from './protocol.js?v=18086ea6';
import { blendStats, blendLabel } from './flours.js?v=18086ea6';
import { suggestPlan, defaultLeadHours } from './advisor.js?v=18086ea6';
