...
import { DEFAULT_RECIPE } from './dough.js?v=1903f6bd';
import { DEFAULT_SCHEDULE } from './protocol.js?v=1903f6bd';
import { blendStats, blendLabel } from './flours.js?v=1903f6bd';
import { suggestPlan, defaultLeadHours } from './advisor.js?v=1903f6bd';
