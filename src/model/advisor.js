...
import { maturationUnits, fermentUnits, maturationRateAt, yeastForFU, DEFAULT_MODEL } from './ferment.js?v=23f40929';
import { maturationCeilingForW, hydrationRangeForW, findFlour } from './flours.js?v=23f40929';
import { DEFAULT_SCHEDULE } from './protocol.js?v=23f40929';
