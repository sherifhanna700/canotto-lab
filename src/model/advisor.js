...
import { maturationUnits, fermentUnits, maturationRateAt, yeastForFU, DEFAULT_MODEL } from './ferment.js?v=877314ec';
import { maturationCeilingForW, hydrationRangeForW, findFlour } from './flours.js?v=877314ec';
import { DEFAULT_SCHEDULE } from './protocol.js?v=877314ec';
