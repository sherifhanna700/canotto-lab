...
import { maturationUnits, fermentUnits, maturationRateAt, yeastForFU, DEFAULT_MODEL } from './ferment.js?v=6a56bc58';
import { maturationCeilingForW, hydrationRangeForW, findFlour } from './flours.js?v=6a56bc58';
import { DEFAULT_SCHEDULE } from './protocol.js?v=6a56bc58';
