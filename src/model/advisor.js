...
import { maturationUnits, fermentUnits, maturationRateAt, yeastForFU, DEFAULT_MODEL } from './ferment.js?v=53a849de';
import { maturationCeilingForW, hydrationRangeForW, findFlour } from './flours.js?v=53a849de';
import { DEFAULT_SCHEDULE } from './protocol.js?v=53a849de';
