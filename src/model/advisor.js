...
import { maturationUnits, fermentUnits, maturationRateAt, yeastForFU, DEFAULT_MODEL } from './ferment.js?v=3463b6fe';
import { maturationCeilingForW, hydrationRangeForW, findFlour } from './flours.js?v=3463b6fe';
import { DEFAULT_SCHEDULE } from './protocol.js?v=3463b6fe';
