...
import { maturationUnits, fermentUnits, maturationRateAt, yeastForFU, DEFAULT_MODEL } from './ferment.js?v=57af795c';
import { maturationCeilingForW, hydrationRangeForW, findFlour } from './flours.js?v=57af795c';
import { DEFAULT_SCHEDULE } from './protocol.js?v=57af795c';
