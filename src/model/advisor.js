...
import { maturationUnits, fermentUnits, maturationRateAt, yeastForFU, DEFAULT_MODEL } from './ferment.js?v=4a2bd96a';
import { maturationCeilingForW, hydrationRangeForW, findFlour } from './flours.js?v=4a2bd96a';
import { DEFAULT_SCHEDULE } from './protocol.js?v=4a2bd96a';
