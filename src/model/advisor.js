...
import { maturationUnits, fermentUnits, maturationRateAt, yeastForFU, DEFAULT_MODEL } from './ferment.js?v=37fdeb15';
import { maturationCeilingForW, hydrationRangeForW, findFlour } from './flours.js?v=37fdeb15';
import { DEFAULT_SCHEDULE } from './protocol.js?v=37fdeb15';
