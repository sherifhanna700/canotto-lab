...
import { maturationUnits, fermentUnits, maturationRateAt, yeastForFU, DEFAULT_MODEL } from './ferment.js?v=4b76d5b2';
import { maturationCeilingForW, hydrationRangeForW, findFlour } from './flours.js?v=4b76d5b2';
import { DEFAULT_SCHEDULE } from './protocol.js?v=4b76d5b2';
