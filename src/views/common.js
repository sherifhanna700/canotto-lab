...
import { h, numberField, selectField, pill } from '../lib/ui.js?v=87d1918f';
import { toDisplay, fromDisplay, deltaToDisplay, deltaFromDisplay, round } from '../model/units.js?v=87d1918f';
import { SCORE_KEYS, overallScore } from '../model/recipes.js?v=87d1918f';
