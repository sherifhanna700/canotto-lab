...
import { h, toast, icon, confirmDialog } from '../lib/ui.js?v=3796c570';
import { update, photosForBake, addPhotoRecord, removePhotoRecord, removePhotoRecordsFor } from '../lib/store.js?v=3796c570';
