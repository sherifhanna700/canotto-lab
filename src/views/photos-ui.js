...
import { h, toast, icon, confirmDialog } from '../lib/ui.js?v=97765f5d';
import { update, photosForBake, addPhotoRecord, removePhotoRecord, removePhotoRecordsFor } from '../lib/store.js?v=97765f5d';
