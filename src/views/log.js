...
import { h, card, pill, chip, selectField, numberField, toast, icon, confirmDialog } from '../lib/ui.js?v=37fdeb15';
import { update, updateBake, deleteBake, download, exportBakesJSON } from '../lib/store.js?v=37fdeb15';
import { computeRecipe } from '../model/dough.js?v=37fdeb15';
import { scheduleStages } from '../model/protocol.js?v=37fdeb15';
import { fermentUnits } from '../model/ferment.js?v=37fdeb15';
import { overallScore, SCORE_KEYS } from '../model/recipes.js?v=37fdeb15';
import { FACTORS, OUTCOMES, derive, findFactor, findOutcome, factorValue, factorLabel } from '../model/metrics.js?v=37fdeb15';
import { scatterChart, barChart, linearFit } from '../lib/charts.js?v=37fdeb15';
import { fmtTemp, fmtDuration, round } from '../model/units.js?v=37fdeb15';
import { diagnose, DIAGNOSTICS } from '../model/diagnostics.js?v=37fdeb15';
import { stars, scoreInputs, tempField } from './common.js?v=37fdeb15';
import { bakeCSV } from '../lib/csv.js?v=37fdeb15';
