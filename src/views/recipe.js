...
import { h, card, numberField, selectField, sliderField, textField, pill, stat, toast, icon, confirmDialog } from '../lib/ui.js?v=97765f5d';
import { update, editCurrent, addRecipe, deleteRecipe, activateRecipe, restoreHouseRecipe, download, exportRecipesJSON, exportRecipeJSON } from '../lib/store.js?v=97765f5d';
import { ingredientRows, YEAST_LABEL, effectiveYeastPct, convertYeast, computeRecipe } from '../model/dough.js?v=97765f5d';
import { floursByCountry, blendStats, blendLabel, hydrationRangeForW } from '../model/flours.js?v=97765f5d';
import { scheduleStages, solveSchedule } from '../model/protocol.js?v=97765f5d';
import { fermentUnits, maturationUnits, stageBreakdown, yeastForFU, doughTempFrom, doughTempVerdict, frictionFrom } from '../model/ferment.js?v=97765f5d';
import { suggestPlan, reviewPlan, defaultLeadHours, coldProofWindow, coldProofVerdict, hoursForMaturation, HOUSE_REFERENCE } from '../model/advisor.js?v=97765f5d';
import { recipeFromBlend, deriveRecipe, recipeRating, overallScore } from '../model/recipes.js?v=97765f5d';
import { fmtGrams, fmtTemp, fmtTempDelta, fmtDuration, round } from '../model/units.js?v=97765f5d';
import { recipeLink, copyText } from '../lib/share.js?v=97765f5d';
import { findMixer, mixerLabel } from '../model/equipment.js?v=97765f5d';
import { tempField, tempDeltaField, ratingBadge, stars, } from './common.js?v=97765f5d';
