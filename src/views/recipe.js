...
import { h, card, numberField, selectField, sliderField, textField, pill, stat, toast, icon, confirmDialog } from '../lib/ui.js?v=1903f6bd';
import { update, editCurrent, addRecipe, deleteRecipe, activateRecipe, restoreHouseRecipe, download, exportRecipesJSON, exportRecipeJSON } from '../lib/store.js?v=1903f6bd';
import { ingredientRows, YEAST_LABEL, effectiveYeastPct, convertYeast, computeRecipe } from '../model/dough.js?v=1903f6bd';
import { floursByCountry, blendStats, blendLabel, hydrationRangeForW } from '../model/flours.js?v=1903f6bd';
import { scheduleStages, solveSchedule } from '../model/protocol.js?v=1903f6bd';
import { fermentUnits, maturationUnits, stageBreakdown, yeastForFU, doughTempFrom, doughTempVerdict, frictionFrom } from '../model/ferment.js?v=1903f6bd';
import { suggestPlan, reviewPlan, defaultLeadHours, coldProofWindow, coldProofVerdict, hoursForMaturation, HOUSE_REFERENCE } from '../model/advisor.js?v=1903f6bd';
import { recipeFromBlend, deriveRecipe, recipeRating, overallScore } from '../model/recipes.js?v=1903f6bd';
import { fmtGrams, fmtTemp, fmtTempDelta, fmtDuration, round } from '../model/units.js?v=1903f6bd';
import { recipeLink, copyText } from '../lib/share.js?v=1903f6bd';
import { findMixer, mixerLabel } from '../model/equipment.js?v=1903f6bd';
import { tempField, tempDeltaField, ratingBadge, stars, } from './common.js?v=1903f6bd';
import { go } from '../app.js?v=1903f6bd';
