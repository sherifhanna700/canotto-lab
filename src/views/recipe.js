...
import { h, card, numberField, selectField, sliderField, textField, pill, stat, toast, icon, confirmDialog } from '../lib/ui.js?v=877314ec';
import { update, editCurrent, addRecipe, deleteRecipe, activateRecipe, restoreHouseRecipe, download, exportRecipesJSON, exportRecipeJSON } from '../lib/store.js?v=877314ec';
import { ingredientRows, YEAST_LABEL, effectiveYeastPct, convertYeast, computeRecipe } from '../model/dough.js?v=877314ec';
import { floursByCountry, blendStats, blendLabel, hydrationRangeForW } from '../model/flours.js?v=877314ec';
import { scheduleStages, solveSchedule } from '../model/protocol.js?v=877314ec';
import { fermentUnits, maturationUnits, stageBreakdown, yeastForFU, doughTempFrom, doughTempVerdict, frictionFrom } from '../model/ferment.js?v=877314ec';
import { suggestPlan, reviewPlan, defaultLeadHours, coldProofWindow, coldProofVerdict, hoursForMaturation, HOUSE_REFERENCE } from '../model/advisor.js?v=877314ec';
import { recipeFromBlend, deriveRecipe, recipeRating, overallScore } from '../model/recipes.js?v=877314ec';
import { fmtGrams, fmtTemp, fmtTempDelta, fmtDuration, round } from '../model/units.js?v=877314ec';
import { recipeLink, copyText } from '../lib/share.js?v=877314ec';
import { findMixer, mixerLabel } from '../model/equipment.js?v=877314ec';
import { tempField, tempDeltaField, ratingBadge, stars, } from './common.js?v=877314ec';
import { go } from '../app.js?v=877314ec';
